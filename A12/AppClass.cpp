...
void AppClass::InitVariables(void)
{
	...
	//creating bounding objects for all models
	m_pBS0 = boManager->addBO(m_pMeshMngr->GetVertexList("Zombie"));
	m_pBS1 = boManager->addBO(m_pMeshMngr->GetVertexList("Steve"));
	m_pBS2 = boManager->addBO(m_pMeshMngr->GetVertexList("Cow"));

	///////////////ADD bso through the bounding manager, save return as an int
	...
	boManager->setAllBOVisibility(true, false, true);
}
...
void AppClass::Update(void)
{
	...
	matrix4 mTranslation = glm::translate(-10.0f,0.0f,0.0f);// glm::translate(v3Current);
	...
	boManager->setBOModelMatrix(m_pBS0, m_pMeshMngr->GetModelMatrix("Zombie"));
	boManager->setBOModelMatrix(m_pBS1, m_pMeshMngr->GetModelMatrix("Steve"));
	boManager->setBOModelMatrix(m_pBS2, m_pMeshMngr->GetModelMatrix("Cow"));
